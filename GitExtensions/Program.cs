    ...
    internal static class Program
    {
        ...
        private static string GetWorkingDir(string[] args)
        {
            ...
            if (args.Length >= 3)
            {
                ...
                // https://github.com/jharajnish30/gitextensions-rkj/issues/3489
        ...
        private static bool LocateMissingGit()
        {
            ...
            switch (dialogResult)
            {
                ...
                case 1:
                    {
                        OsShellUtil.OpenUrlInDefaultBrowser(@"https://github.com/jharajnish30/gitextensions-rkj/wiki/Application-Dependencies#git");
                        return false;
                    }
